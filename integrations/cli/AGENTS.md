...
TOON by default with a minimal field set — measured at 58-94% fewer tokens than full JSON on directory listings, far less on file content. A trailing `help[]` block suggests the next command.
