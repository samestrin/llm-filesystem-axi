...
// BinaryPath is the path to the llm-filesystem binary. It defaults to the
// standard install location and is normally replaced at startup by
// ResolveBinaryPath (see binpath.go).
